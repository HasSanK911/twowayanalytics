        ...
        <div className=''>
            ...
            <div className="flex gap-3">
                ...
                <div className='w-full'>
                    <select className="block  rounded-3xl w-full border border-gray-300 bg-white px-3 h-[47px] mt-2 py-2 text-gray-900 focus:border-blue-500 focus:ring focus:ring-blue-200">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-4 mt-0">
                <div className="flex items-end gap-3 justify-start mt-4">
                    ...
                    ><img src={add} alt="filtericon" />  Add Value</button>
                </div>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-4 mt-4">
                <div>
                    <label htmlFor="" className="text-[#5A5A5A] mb-4">Add Value</label>
                    <input className="block w-full rounded-3xl  border border-gray-300 bg-white px-3 h-[47px] mt-2 py-2 text-gray-900 focus:border-blue-500 focus:ring focus:ring-blue-200 form-control" type="text" placeholder="Enter New Value" />
                </div>
                <div className="flex items-end gap-3 justify-start mt-4">
                    <button className="bg-[#1A3561] flex items-center justify-center gap-2 btn text-[#ffffff] h-[47px] w-[165px] text-lg font-semibold rounded-lg"
                    ><img src={add} alt="add" /> Save</button>
                </div>
            </div>
